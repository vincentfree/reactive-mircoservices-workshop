...
*/}}
{{- define "vertx-rest-service.name" -}}
...
*/}}
{{- define "vertx-rest-service.fullname" -}}
...
*/}}
{{- define "vertx-rest-service.chart" -}}
...
Common labels
*/}}
{{- define "vertx-rest-service.labels" -}}
app.kubernetes.io/name: {{ include "vertx-rest-service.name" . }}
helm.sh/chart: {{ include "vertx-rest-service.chart" . }}
